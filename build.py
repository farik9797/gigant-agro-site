...
PAGES = [
 ...
 ('kit-dlya-ovec',         'kit-dlya-ovec.html',
  'Комплект электропастуха для овец и коз, 1 га — 125 000 ₸',
  'Готовый комплект для овец и коз на 1 га: генератор 4 Дж, шнур 2 × 500 м, аккумулятор 12 В, двое пружинных ворот, 100 изоляторов. Склад в Алматы.',
  'assets/img/kit-ovcy-box.jpg'),
 ('kit-dlya-krs',          'kit-dlya-krs.html',
  'Комплект электропастуха для КРС, 5 га — 145 000 ₸',
  'Готовый комплект для КРС на 5 га: генератор 4 Дж, шнур 1000 м, аккумулятор 12 В 7 Ач, пружинные ворота, 100 изоляторов, табличка. Склад в Алматы.',
  'assets/img/kit-krs-box.jpg'),
 ('kit-dlya-loshadej',     'kit-dlya-loshadej.html',
  'Комплект электропастуха для лошадей, 6 га — 125 000 ₸',
  'Готовый комплект для лошадей на 6 га: генератор 2,5 Дж, шнур 1000 м, 100 изоляторов с саморезом, пружинные ворота, адаптер 220 В. Склад в Алматы.',
  'assets/img/kit-loshadi-box.jpg'),
 ('kit-avtonomnyj',        'kit-avtonomnyj.html',
  'Автономный комплект электропастуха с солнечной панелью',
  'Электропастух 15 или 25 Дж, солнечная панель, MPPT-контроллер и аккумулятор 12 В для пастбищ без розетки. Собираем под ваш периметр.',
  'assets/img/solar-energizer.jpg'),
 ('podbor',                'podbor.html',
